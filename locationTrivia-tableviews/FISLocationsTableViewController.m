...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString* locationNameForLabel = location.name;
    
    cell.textLabel.text = locationNameForLabel;
    
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%li", [location.trivia count]];
    
   // NSLog(@"%@", location.trivia);
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    FISLocation* location = self.locations[selectedItem.row];
